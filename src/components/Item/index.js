...
export default class Item extends React.Component {
  ...
  renderItem = (text) => {
    ...
    console.log('---render Item', checkBox);
    return (
      <div className="app__body-item" id={this.props.data.id} onDoubleClick={this.doubleClickForEdit}
           onMouseOver={this.showDeleteBtn} onMouseEnter={this.showDeleteBtn} onMouseLeave={this.hideDeleteBtn}>
        <input
          type="checkbox"
          checked={checkBox}
        ...
        <div className="app__body-text">
          {this.state.visibleEdit && <span>{text}</span>}
          {!this.state.visibleEdit && <Edit text={text} editTextFromInput={editTextFromInput}/>}
        </div>
        <div className="app__body-deleteItem">
          {this.state.visibleDelete &&
          <button className="app__btn-delete" id={this.props.data.id} onClick={this.deleteItemOnClick}/>}
        </div>
      </div>
    )
  };
